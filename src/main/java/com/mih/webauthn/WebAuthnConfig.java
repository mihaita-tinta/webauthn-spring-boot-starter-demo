...
public class WebAuthnConfig {
    ...
    @Bean
    public CredentialRepositoryService credentialRepositoryService(AppCredentialsRepository credentialsRepository, AppUserRepository appUserRepository) {
        return new CredentialRepositoryService(credentialsRepository, appUserRepository);
    }
